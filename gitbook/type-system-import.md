...
{% codeasset haxe %}assets/Import.hx{% endcodeasset %}
...
{% codeasset haxe %}assets/Import2.hx{% endcodeasset %}
...
{% codeasset haxe %}assets/Import3.hx{% endcodeasset %}
...
{% codeasset haxe %}assets/ImportWildcard.hx{% endcodeasset %}
...
{% codeasset haxe %}assets/ImportAlias.hx{% endcodeasset %}
